...
CREATE TABLE SpotifyClone.following(
  ...
  CREATE TABLE SpotifyClone.history(
    ...
    PRIMARY KEY(users_id, song_id, reproduction_date),
    FOREIGN KEY (users_id) REFERENCES SpotifyClone.users(users_id),
...
INSERT INTO SpotifyClone.following (users_id, artist_id) VALUES
(1, 1),
(1, 2),
(1, 3),
(2, 1),
...
INSERT INTO SpotifyClone.songs (song_name, length, album_id) VALUES
('BREAK MY SOUL', 279, 1),
...
INSERT INTO SpotifyClone.history (users_id, song_id, reproduction_date) VALUES
